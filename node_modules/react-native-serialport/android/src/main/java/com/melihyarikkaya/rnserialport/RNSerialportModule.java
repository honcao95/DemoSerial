...
public class RNSerialportModule extends ReactContextBaseJavaModule {
 ...
 public void isServiceStarted(Promise promise) {
  ...
  @ReactMethod
  public void writeCmdSetTime() {
     byte[] bytes = new byte[]{(byte)160, 3, 1, (byte)144, (byte)204};     //160, 3, 1, 144, 204
     if(!usbServiceStarted){
      eventEmit(onErrorEvent, createError(Definitions.ERROR_USB_SERVICE_NOT_STARTED, Definitions.ERROR_USB_SERVICE_NOT_STARTED_MESSAGE));
      return;
    }
    ...
    System.out.print("Stop Inventory: ");
    System.out.println(Arrays.toString(bytes));
    serialPort.write(bytes);
  }  

  @ReactMethod
  public void writeCmdId() {
    //  byte[] bytes = new byte[]{(byte)160, 4, 1, (byte)137, 1, (byte)209};        //160, 4, 1, 128, 1, 218
     byte[] bytes = new byte[]{(byte)160, 4, 1, (byte)137, 1, (byte)209}; 
     if(!usbServiceStarted){
      eventEmit(onErrorEvent, createError(Definitions.ERROR_USB_SERVICE_NOT_STARTED, Definitions.ERROR_USB_SERVICE_NOT_STARTED_MESSAGE));
      return;
    }
